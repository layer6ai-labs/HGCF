...
```
_Update: Original Yelp data on the website has been updated by Yelp and the 2020 version we used has been overwritten. Using our preprocessing script on the updated Yelp data will give difrerent statistics and thus different results. We've uploaded our preprocessed .pkl file [here](https://github.com/layer6ai-labs/HGCF/tree/main/yelp20)._
